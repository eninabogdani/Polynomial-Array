...
int main() {
	...
	// Poly C1;
	// cout << "Enter terms for Poly C: " << endl;
	// cin >> C1;
	// cout << C1;
    // cout << (A + B) << endl;
    // cout << (A - B) << endl;
